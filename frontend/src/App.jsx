...
import {
  ...
  KeyRound, LockKeyhole, Mail, Phone, ShieldCheck, UserRound,
} from 'lucide-react';
      ...
      <section className="form-panel">
        <div className="form-container">
          ...
          <form onSubmit={submit}>
            <Field label="Login ID or email" icon={Mail} placeholder="e.g. DFAN20260001" autoComplete="username" required />
            <Field
...
export default function App() {
  return <Routes><Route path="/login" element={<Login />} /><Route path="/signup" element={<Signup />} /><Route path="*" element={<Navigate to="/login" replace />} /></Routes>;
}
